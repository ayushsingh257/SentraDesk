...
export const metadata: Metadata = { title: 'Cookie Policy — CCGP' }
  ...
  return (
    <div className="page-container py-16 max-w-3xl">
      ...
      <div className="space-y-8 text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
        <section><h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-3">What We Store</h2><p>CCGP uses browser localStorage (not cookies) to store your authentication tokens and theme preference. No third-party analytics or advertising trackers are used.</p></section>
        ...
        <section><h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-3">No Tracking</h2><p>CCGP does not use Google Analytics, Facebook Pixel, or any third-party tracking services. We do not share your data with advertisers.</p></section>
      </div>
    </div>
  )
}
