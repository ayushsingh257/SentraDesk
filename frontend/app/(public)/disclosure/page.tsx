...
export const metadata: Metadata = { title: 'Responsible Disclosure — CCGP' }
    ...
    <div className="page-container py-16 max-w-3xl">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-neutral-600 dark:text-neutral-400 text-sm leading-relaxed">
        <section>
          ...
          <p>We are committed to the security of the CCGP platform and the data of all users. We welcome responsible disclosure of security vulnerabilities by security researchers.</p>
        </section>
        <section>
          <h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-3">How to Report</h2>
          <p>Email <strong>security@ccgp.gov.in</strong> with: a description of the vulnerability, reproduction steps, the potential impact, and any suggested mitigations. Do not disclose publicly until we have had an opportunity to investigate and remediate.</p>
        </section>
        <section>
