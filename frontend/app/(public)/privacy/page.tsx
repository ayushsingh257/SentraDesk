...
export const metadata: Metadata = { title: 'Privacy Policy — CCGP' }
  ...
  return (
    <div className="page-container py-16 max-w-3xl">
      ...
      <div className="space-y-8 text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
        ...
        <section><h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-3">Data Retention</h2><p>Complaint and investigation records are retained permanently as required for legal and evidentiary purposes. You may request access to your own data by contacting support@ccgp.gov.in.</p></section>
        <section><h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-3">Contact</h2><p>For privacy concerns: privacy@ccgp.gov.in</p></section>
      </div>
    </div>
  )
}
