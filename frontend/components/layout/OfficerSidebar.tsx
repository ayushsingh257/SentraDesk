...
export function OfficerSidebar() {
  ...
  const navigation: NavItem[] = [
    ...
    { name: 'Assigned Tickets', href: '/officer/tickets', icon: FileText },
    { 
      name: 'Approvals', 
      href: '/officer/approvals', 
      icon: CheckSquare,
      roles: ['supervisor', 'senior_investigator', 'state_administrator', 'system_administrator'] 
    },
    { name: 'Notifications', href: '/officer/notifications', icon: Bell, badgeKey: 'unread' },
    ...
    <div className="flex flex-col h-full bg-white dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800">
      ...
      <div className="flex items-center gap-2 px-6 py-5 border-b border-neutral-100 dark:border-neutral-800">
        ...
        <div className="flex flex-col">
          <span className="font-bold text-neutral-900 dark:text-white leading-none">SentraDesk</span>
          <span className="text-[10px] text-primary-600 dark:text-primary-400 font-bold mt-0.5 tracking-wider uppercase">
            {user ? getRoleLabel(user.role) : 'Officer Portal'}
          </span>
        </div>
      </div>
    ...
    <>
      ...
      <div className="lg:hidden flex items-center justify-between px-6 py-4 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 fixed top-0 w-full z-20">
        <Link href="/officer/dashboard" className="flex items-center gap-2">
          ...
          <span className="font-bold text-neutral-900 dark:text-white text-base">SentraDesk</span>
        </Link>
